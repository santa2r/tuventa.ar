					...
					?>
						<div>
							...
							<div class="bor8 bg0 m-b-12">
								<input id="txtDireccion" class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="state" placeholder="Direccion de envio calle y altura">
							</div>
							<div class="bor8 bg0 m-b-22">
								<input id="txtCiudad" class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="postcode" placeholder="Ciudad / provincia">
							</div>

							<label>Datos Clientes</label>
							<div class="bor8 bg0 m-b-12">
								<input id="txtNombre" class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="nombre" placeholder="Nombre">
							</div>
							<div class="bor8 bg0 m-b-12">
								<input id="txtApellido" class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="apellido" placeholder="Apellido">
							</div>
							<div class="bor8 bg0 m-b-12">
								<input id="txtDni" class="stext-111 cl8 plh3 size-111 p-lr-15" type="number" name="dni" placeholder="Numero de dni">
							</div>
							<div class="bor8 bg0 m-b-12">
								<input id="txtCorreo" class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="correo" placeholder="correo electronico">
							</div>
							<div class="bor8 bg0 m-b-12">
								<input id="txtCelular" class="stext-111 cl8 plh3 size-111 p-lr-15" type="number" name="celular" placeholder="celular sin el 0 y sin el 15">
							</div>
							<div class="bor8 bg0 m-b-12">
								<input id="txtDomicilio" class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="domicilio" placeholder="Domicilio Calle y altura">
							</div>
							<div class="bor8 bg0 m-b-22">
								<input id="txtProvincia" class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="provincia" placeholder="Ciudad / Provincia">
							</div>
